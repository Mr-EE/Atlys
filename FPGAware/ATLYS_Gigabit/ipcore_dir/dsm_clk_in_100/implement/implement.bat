...
xst -ifn xst.scr
move dsm_clk_in_100_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dsm_clk_in_100_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dsm_clk_in_100_exdes.ucf dsm_clk_in_100_exdes

echo 'Running map'
map -timing -pr b dsm_clk_in_100_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dsm_clk_in_100_exdes -w routed.ncd routed.vhd
cd ..
